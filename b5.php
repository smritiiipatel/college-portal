...
<head>
    <meta charset="UTF-8">
    <title>Notes Details - Study-Sphere</title>
...
<body>
    ...
    <div class="form-container">
        <h2>NOTES DETAILS</h2>
        <form action="b5action.php" enctype="multipart/form-data" method="post">
            <input type="date" name="a1" placeholder="Enter your date" required>
            <input type="text" name="a2" placeholder="Enter branch" required>
            <input type="number" name="a3" placeholder="Enter semester" required>
            <input type="text" name="a4" placeholder="Enter subject" required>
            <input type="file" name="f1" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
