...
<head>
    <meta charset="UTF-8">
    <title>Student Registration - Study-Sphere</title>
...
<body>
    ...
    <!-- Animated Stationery SVGs (background) -->
    ...
    <div class="reg-container">
        ...
        <form action="b7action.php">
            <input type="text" name="a1" placeholder="Enter your name" required>
            <input type="number" name="a2" placeholder="Enter your roll no." required>
            <input type="text" name="a3" placeholder="Enter your branch" required>
            <input type="text" name="a4" placeholder="Enter your semester" required>
            <input type="number" name="a5" placeholder="Your mobile no." required>
