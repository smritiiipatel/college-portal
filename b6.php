...
<head>
    <meta charset="UTF-8">
    <title>Student Login - Study-Sphere</title>
...
<body>
    ...
    <div class="login-container">
        <h2>STUDENT LOGIN</h2>
        <form action="b6action.php">
            <input type="text" name="t1" placeholder="Enter your name" required>
            <input type="text" name="t2" placeholder="Enter your roll no." required>
            <input type="submit" value="Login">
        </form>
        <a href="b7.php" class="register-link">Registration Form</a>
    </div>
    <script>
