...
<body>
    ...
    <header>
        <h2 style="margin: 35px 0 18px 0; color: #2141c2; letter-spacing:2px; text-align:center;">Quick Actions</h2>
    </header>
    <div class="quick-actions-container">
        <div class="quick-action">
            <div class="icon">💾</div>
            <div>Save Notes</div>
            <a href="b9.php">Save</a>
        </div>
        <div class="quick-action">
            <div class="icon">📈</div>
            <div>View Marks</div>
            <a href="view-marks.php">View</a>
        </div>
        <div class="quick-action">
            <div class="icon">📅</div>
            <div>View Timetable</div>
            <a href="show-timetable.php">View</a>
        </div>
        <div class="quick-action">
            <div class="icon">🔔</div>
            <div>View Notification</div>
            <a href="view-notification.php">View</a>
        </div>
    </div>
    <script>
